...
class PdfStyleCVMixLayoutExtractor(BaseLayoutExtractor):
    ...
    def _merge_text_content(self, pdf_elements: List[LayoutElement]) -> str:
        ...
        sorted_elements = self._sort_elements_by_position(pdf_elements)
    ...
    def _sort_elements_by_position(self, elements: List[LayoutElement]) -> List[LayoutElement]:
        """
        Sort elements by natural reading order (top-to-bottom, left-to-right).
        Uses a more sophisticated algorithm that:
